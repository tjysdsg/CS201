 ...
 *  of neighbors (HashSet of Strings).
 *
 *  Remarks
 *  -------
...
/**
 * The {@code Graph} class represents an undirected graph of vertices with
 ...
 * <a href="https://introcs.cs.princeton.edu/45graph">Section 4.5</a> of
...
public class Graph {
	 ...
	 *
	 * @param v the vertex
	 * @return {@code true} if {@code v} is a vertex in this graph, {@code false}
	 *         otherwise
	 */
	 ...
	 * @param v one vertex in the edge
	 * @param w the other vertex in the edge
	 * @return {@code true} if {@code v-w} is a vertex in this graph, {@code false}
	 *         otherwise
	 * @throws IllegalArgumentException if either {@code v} or {@code w} is not a
